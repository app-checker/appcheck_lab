<template>
  <!-- https://commons.wikimedia.org/wiki/File:Kotlin_logo.svg -->
  <svg :width="w" :height="h" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
...
const w = computed<string>(()=> {
  return props.width + 'px'
})
const h = computed<string>(()=> {
